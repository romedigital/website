...
export default function Colosseum() {
  return (
    <section className={styles.section}>
        ...
        <p>We focus on creating websites for small businesses that build trust with your potential clients, and gains you MORE customers. We write each line of code by hand to make sure your site runs smoothly, has great SEO, and is extremely mobile-friendly, bringing in more customers and revenue for your business.</p>
