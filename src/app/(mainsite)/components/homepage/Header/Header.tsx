...
export default function Header() {
  ...
  return (
    <header className={`${styles.header} main-bg-top`}>
        ...
        <p className={styles.secondTagline}>At Rome Digital, I craft websites that get it done right the first time, and set you and your business apart from the masses. Book a call with me and let's transform your business today!</p>
