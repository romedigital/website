...
export default function ChurchPayment() {
...
<stripe-buy-button
  buy-button-id="buy_btn_1TCWSaKaTewv8x5BplbAQmBV"
...
>
  ...
  return (
    <>
        ...
        <p className={styles.content}>This step secures your spot for your church's amazing website. Your payment is safe, encrypted, and handled securely.🔒
        </p>
